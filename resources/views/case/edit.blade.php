                    ...
                    <form action="{{ route('case.update', $case->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="client_name" id="client_name"
                                    ...
                                    value="{{ old('client_name', $case->client_name) }}" placeholder="Enter client name" required>
                                @error('client_name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="form-control @error('description') is-invalid @enderror" placeholder="Enter description">{{ old('description', $case->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
